    ...
    def onInput_onStart(self):
        ...
        try:
            ...
            for i in range(1, 11):  # 10 повторений
                ...
                names = ["LHipPitch", "LKneePitch", "RHipPitch", "RKneePitch", "LShoulderPitch", "RShoulderPitch"]
                keys = [[0.0, -1.0], [0.0, 1.5], [0.0, -1.0], [0.0, 1.5], [0.0, -1.57], [0.0, -1.57]]  # Бедро на -1.0 рад, колено на 1.5 рад, руки на 90° вверх
                ...
                names = ["LHipPitch", "LKneePitch", "RHipPitch", "RKneePitch", "LShoulderPitch", "RShoulderPitch"]
                keys = [[-1.0, 0.0], [1.5, 0.0], [-1.0, 0.0], [1.5, 0.0], [-1.57, 0.0], [-1.57, 0.0]]  # Возвращение в исходное положение, руки вниз
                times = [[0.5, 3.0], [0.5, 3.0], [0.5, 3.0], [0.5, 3.0], [0.5, 3.0], [0.5, 3.0]]
                self.motion.angleInterpolation(names, keys, times, True)
